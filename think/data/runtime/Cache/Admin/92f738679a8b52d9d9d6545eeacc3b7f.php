...
<meta charset="utf-8">
<title>ExDriver MOV <?php echo L('ADMIN_CENTER');?></title>

<meta name="description" content="This is page-header (.page-header &gt; h1)">
<meta name="viewport" content="width=device-width, initial-scale=1.0">

<link rel="icon" href="/think/public/images/favicon_ExDriver.ico" type="image/x-icon">
<link rel="shortcut icon" href="/think/public/images/favicon_ExDriver.ico" type="image/x-icon">
...
<![endif]-->
<link rel="stylesheet" href="/think/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/think/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/think/admin/themes/simplebootx/Public/assets/images/logo-18.png">
						ExDriver MOV <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >

					<a class="btn btn-small btn-warning" href="/think/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/think/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/think/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>