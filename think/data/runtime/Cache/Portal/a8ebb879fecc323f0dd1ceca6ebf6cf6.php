...
<div class="container tc-main">
	...
	<div class="index-mv-list  ">
		<?php if(is_array($movie['juqing'])): foreach($movie['juqing'] as $key=>$vo): ?><li class="col-xs-6 col-md-3">
 ...
 <h2>喜剧</h2>
	<div class="index-mv-list  ">
		<?php if(is_array($movie['xiju'])): foreach($movie['xiju'] as $key=>$vo): ?><li class="col-xs-6 col-md-3">
							<a href="<?php echo leuu('article/index',array('id'=>$vo['_id']));?>" class="index-mv-thumbnail">
									<img src="<?php echo ($vo["image"]); ?>" class="img-responsive" alt="..." >
									<p><?php echo ($vo["name"]); ?> <br/><span class="index-score-lable"><?php echo ($vo["douban_rating"]); ?></span></p>
							</a>
  ...
  <h2>爱情</h2>
	<div class="index-mv-list  ">
		<?php if(is_array($movie['aiqing'])): foreach($movie['aiqing'] as $key=>$vo): ?><li class="col-xs-6 col-md-3">
							<a href="<?php echo leuu('article/index',array('id'=>$vo['_id']));?>" class="index-mv-thumbnail">
									<img src="<?php echo ($vo["image"]); ?>" class="img-responsive" alt="..." >
									<p><?php echo ($vo["name"]); ?> <br/><span class="index-score-lable"><?php echo ($vo["douban_rating"]); ?></span></p>
							</a>
  ...
  <h2>惊悚</h2>
	<div class="index-mv-list  ">
		<?php if(is_array($movie['jingsong'])): foreach($movie['jingsong'] as $key=>$vo): ?><li class="col-xs-6 col-md-3">
							<a href="<?php echo leuu('article/index',array('id'=>$vo['_id']));?>" class="index-mv-thumbnail">
									<img src="<?php echo ($vo["image"]); ?>" class="img-responsive" alt="..." >
									<p><?php echo ($vo["name"]); ?> <br/><span class="index-score-lable"><?php echo ($vo["douban_rating"]); ?></span></p>
							</a>
  ...
  <h2>动画</h2>
	<div class="index-mv-list  ">
		<?php if(is_array($movie['donghua'])): foreach($movie['donghua'] as $key=>$vo): ?><li class="col-xs-6 col-md-3">
							<a href="<?php echo leuu('article/index',array('id'=>$vo['_id']));?>" class="index-mv-thumbnail">
									<img src="<?php echo ($vo["image"]); ?>" class="img-responsive" alt="..." >
									<p><?php echo ($vo["name"]); ?> <br/><span class="index-score-lable"><?php echo ($vo["douban_rating"]); ?></span></p>
							</a>
